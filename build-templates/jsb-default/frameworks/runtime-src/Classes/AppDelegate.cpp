...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::create("DemoLeaderBoardNative");
#else
        glview = GLViewImpl::createWithRect("DemoLeaderBoardNative", cocos2d::Rect(0,0,900,640));
#endif
    ...
    jsb_set_xxtea_key("a2567b85-104b-43");
